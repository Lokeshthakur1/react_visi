    ...
    render() {
        return (
            <div>
                <main>
                    ...
                    <div className="container">
                        <section>
                            <h2 className="title my-5 wow fadeIn  font-weight-bold text-uppercase" data-wow-delay="0.2s">
                            ...
                            <h4 className="title my-5 wow fadeIn  font-weight-bold" data-wow-delay="0.2s">
                                Information We <span className="font-weight-light">Collect</span>
                            </h4>
                            <p className="text-justify">We do not (knowingly) collect personal information from persons under the age of eighteen. We also
                            give users the option of receiving useful product information (such as updates, pest alerts and
                            associated product offerings), via opt-in permission based email. We fully ensure your privacy and
                            value your trust. We will never sell, rent, lease, or give your information to a third party unless
            required to do so by law.</p>
                            <h4 className="title my-5 wow fadeIn  font-weight-bold" data-wow-delay="0.2s">
                                Web Site <span className="font-weight-light">Usage</span>
                            </h4>
                            <p className="text-justify">We may automatically collect IP addresses and Web site usage information when you access our online
                            services. This information helps us evaluate how our visitors navigate our sites on an aggregate
            basis, including but not limited to the number and frequency of visitors, length of visits, etc.</p>
                            <h4 className="title my-5 wow fadeIn  font-weight-bold" data-wow-delay="0.2s">
            ...
            only visible to VisionAize, and 3) devoid of any personally identifiable information.</p>
                            ...
                            <p className="text-justify">Our site might provide links to other sites. When you click on one of these links, you are leaving
                            our site and entering another site that we do not control and for which we cannot be responsible.
                            You should carefully review the privacy statements or policies on any other site that you visit
                            because those privacy statements or policies will apply to your visit to that site and may be very
            different from our policy.</p>
                            <h4 className="title my-5 wow fadeIn  font-weight-bold" data-wow-delay="0.2s">
            ...
            and we ask that minors do not submit any personal information to us.</p>
                            <h4 className="title my-5 wow fadeIn  font-weight-bold" data-wow-delay="0.2s">
                                Miscellaneous <span className="font-weight-light"></span>
                            </h4>
                            <p className="text-justify">If any portion of this policy is deemed unlawful, void or unenforceable by any arbitrator or court of
                            competent jurisdiction, this policy as a whole shall not be deemed unlawful, void or unenforceable,
                            but only that portion of this policy that is unlawful, void or unenforceable shall be stricken from
            this policy.</p>
                            <p>The headings contained in this policy are for convenience of reference only, are not to be considered
