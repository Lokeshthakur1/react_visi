                            ...
                            <div class="col-md-8">
                                <section>
                                    <h2 class="title mb-5 wow fadeIn  font-weight-bold text-uppercase" data-wow-delay="0.2s">
                                        Oil & Gas <span class="font-weight-light">Situational Awareness
                                        Solutions</span>
                                    </h2>
                                    <div className="text-center mb-4">
                                        <img src="img/svg/oil&gas.svg" className="img-fluid w-100" />
                                    </div>
                                    <div className="row">
                                        <div className="col-md-12 mt-3">
                                            ...
                                            <div className="list-group p-3 card shadow-lg">
                                                <h4 class="title mb-4 wow fadeIn  font-weight-bold" data-wow-delay="0.2s">
