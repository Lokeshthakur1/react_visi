                ...
                <main>
                    <section className="py-5 case-studies_page">
                        <div className="container">
                            <h2 className="title mb-5 wow fadeIn font-weight-bold text-uppercase" data-wow-delay="0.2s" >Smart Transport Solutions<span className="font-weight-light"></span></h2>
