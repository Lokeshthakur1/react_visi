                            ...
                            <div className="col-md-8">
                                <section>
                                    ...
                                    <div className="mb-4 text-center">
                                        <img src="img/svg/travel.svg" alt="environment" className="w-100" />
                                    </div>
                                    ...
                                    <div className="row mt-4 text-center">
                                        <div className="col-md-6 mb-4">
                                            <div className="border h-100 shadow p-3">
                                                <img src="img/svg/user-experience.svg" height="70" />
                                        ...
                                        <div className="col-md-6  mb-4">
                                            <div className="border h-100 shadow p-3">
                                                <img src="img/svg/office_automation.svg" height="70" />
                                        ...
                                        <div className="col-md-6  mb-4">
                                            <div className="border h-100 shadow p-3">
                                                <img src="img/svg/post-trip.svg" height="70" />
                                        ...
                                        <div className="col-md-6 mb-4">
                                            <div className="border h-100 shadow p-3">
                                                <img src="img/svg/operation.svg" height="70" />
